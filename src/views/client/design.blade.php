@if ($product)
    @php
        $product->applyMeta();
        if(!$o = json_decode($product->options)){
            $o = ['::_'=>0];
        }
        $prodTemplate = [];
        if($product->templates && count($product->templates)){
            foreach ($product->templates as $template) {
                ...
                if($template->elements && $elements = json_decode($template->elements)){
                    $p['elements'] = $elements;
                }
                $prodTemplate[] = $p;
            }
        }
        $fpdProductsJSON[] = $prodTemplate;

        $fpdDesignsJSON = [];
        
    @endphp
<script type="text/javascript">
    var prodOptions = {!!json_encode($o)!!};
    var isMobile = 'False';
    stageHeight = prodOptions.stage_height || screen.height;
    ...
    stageHeight = prodOptions.stage_height || 600;
    stageWidth = prodOptions.stage_width || 500;
    //alert(stageHeight);
    var top = 0;
    var left = 0;
    ...
    jQuery(document).ready(function () {
        var fpdProductsJSON = {!!json_encode($fpdProductsJSON)!!};

        var fpdDesignsJSON = [
            {
                "title": "rồng",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/Khung Rồng.png"
            },
            {
                "title": "hoa hướng dương",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/Khung Hướng dương.png",
                "designs": [
                    {
                        "source": "http://opgiare.com/media/gallery/25/Khung Hướng dương (1).png",
                        "title": "",
                        "thumbnail": "http://opgiare.com/media/gallery/25/Khung Hướng dương (1).png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
                    ...
                    {
                        "source": "http://opgiare.com/media/gallery/25/Khung Hướng dương.png",
                        "title": null,
                        "thumbnail": "http://opgiare.com/media/gallery/25/Khung Hướng dương.png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
            ...
            {
                "title": "đại dương",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/Nền ghép 4.png",
                "designs": [
                    {
                        "source": "http://opgiare.com/media/gallery/24/Nền ghép 4.png",
                        "title": null,
                        "thumbnail": "http://opgiare.com/media/gallery/24/Nền ghép 4.png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
            ...
            {
                "title": "Khung hoa",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/86940de98763defb504f254e40b3888f.png",
                "designs": [
                    {
                        "source": "http://opgiare.com/media/gallery/17/86940de98763defb504f254e40b3888f.png",
                        "title": "",
                        "thumbnail": "http://opgiare.com/media/gallery/17/86940de98763defb504f254e40b3888f.png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
            ...
            {
                "title": "Hạnh phúc",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/3872f1474c374995d16a1eb8ac23b6cb.png",
                "designs": [
                    {
                        "source": "http://opgiare.com/media/gallery/18/3872f1474c374995d16a1eb8ac23b6cb.png",
                        "title": "",
                        "thumbnail": "http://opgiare.com/media/gallery/18/3872f1474c374995d16a1eb8ac23b6cb.png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
            ...
            {
                "title": "Galaxy",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/khung 2 galaxy.png",
                "designs": [
                    {
                        "source": "http://opgiare.com/media/gallery/20/khung 2 galaxy.png",
                        "title": "",
                        "thumbnail": "http://opgiare.com/media/gallery/20/khung 2 galaxy.png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
            ...
            {
                "title": "Khung Love",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/khung 2 vuong xanh.png",
                "designs": [
                    {
                        "source": "http://opgiare.com/media/gallery/19/khung 2 vuong xanh.png",
                        "title": "Khung Love",
                        "thumbnail": "http://opgiare.com/media/gallery/19/khung 2 vuong xanh.png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
            ...
            },
            {
                ...
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/khung 2 tim rừng.png",
                "designs": [
                    {
                        "source": "http://opgiare.com/media/gallery/21/khung 2 tim rừng.png",
                        "title": "",
                        "thumbnail": "http://opgiare.com/media/gallery/21/khung 2 tim rừng.png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
            ...
            {
                "title": "Cafe Sáng",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/Nền ghép 3.png"
            },
            {
                "title": "Ấm áp",
                "thumbnail": "http://opgiare.com/media/gallery/cover/tb/ghép 3.png",
                "designs": [
                    {
                        "source": "http://opgiare.com/media/gallery/23/ghép 3.png",
                        "title": "mẫu 3 ảnh đẹp",
                        "thumbnail": "http://opgiare.com/media/gallery/23/ghép 3.png",
                        "parameters": {
                            "left": 0,
                            "y": 0,
                            "z": -1,
            ...
            [
                {
                    ...
                    "thumbnail": "http://opgiare.com/media/product/cat/xs maxx_(1).png",
                    "options": {
                        "customAdds": {
                            "uploads": true,
                            "texts": true,
                    ...
                    "elements": [
                        {
                            "type": "image",
                            "title": "upload",
                            "source": "http://opgiare.com/media/product/mobile_upload.png",
                            "parameters": {
                                "uploadZone": 0,
                                "scaleX": 1,
                                "scaleY": 1,
        ...
        pluginOpts.customImageAjaxSettings = {
            url: '/products/upload?cat=6&code=202007271595869071',
            data: {
                saveOnServer: 0,
            ...
            fancyProductDesigner.getProductDataURL(function (dataURL) {
                ...
                setTimeout(function () {
                    fancyProductDesigner.getProductDataURL(function (dataURLFull) {
                        ...
                        formdata.append('name', 'Iphone  Xs Max');
                        formdata.append('code', '202007271595869071');
                        ...
                        $('.unit-image-one img').attr('src', dataURL);
                        // $.ajax({
                        //     type: 'POST',
                        //     processData: false,
                        //     contentType: false,
...
<div id="main-container">
    ...
    <p class="fpd-container">
        <input type="hidden" value="202007271595869071" id="UploadCode" />
